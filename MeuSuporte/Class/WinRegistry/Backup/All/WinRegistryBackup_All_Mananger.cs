...
namespace MeuSuporte
{
    ...
    internal class WinRegistryBackup_All_Mananger
    {
        ...
        public async Task Mananger()
        {
            ...
            await RegistryBackup_Key.Backup(NameMachineRun, RegistryLocalMachineRun, WinGlobal_UIService.Instance.ValueUniProgressBar / 4);
            await RegistryBackup_Key.Backup(NameWOW6432Node, RegistryWOW6432Node, WinGlobal_UIService.Instance.ValueUniProgressBar / 4);
            await RegistryBackup_Key.Backup(NameUserRun, RegistryCurrentUserRun, WinGlobal_UIService.Instance.ValueUniProgressBar / 4);
