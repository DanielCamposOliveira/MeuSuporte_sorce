    ...
    internal class WinRestorePoint_EnableProtection
    {
        public async Task<bool> EnableProtection(int ValueUniProgressBar)
        {
            try
            {
                ...
                await WinGlobal_UIService.Instance.AddMessage(@"Proteção do sistema: Habilitado");
                ...
                await Task.Delay(2000);
                await WinGlobal_UIService.Instance.AddMessage(@"Proteção do Sistema: Uso do Espaço do Disco definido para 10%");
            ...
            catch (Exception ex)
            {
                ...
                await WinGlobal_UIService.Instance.AddMessage(@"Proteção do Sistema: Ocorreu um erro ao tentar ativar Proteção do sistema");
                return false;
            }          
        }
